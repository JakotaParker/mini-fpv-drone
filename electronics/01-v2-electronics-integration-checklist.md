...
- [x] Identify the connection point for each subsystem:
  - [x] Motor 1
  - [x] Motor 2
  - [x] Motor 3
  - [x] Motor 4
...
- [x] Label every wire and destination pad
- [x] Create a physical wire-routing plan for the V2 frame
- [x] Decide the electronics stack / component placement order
...
- [x] Verify hardware and screw dimensions
...
- [x] Record any fitment problems
- [x] Update CAD if required
